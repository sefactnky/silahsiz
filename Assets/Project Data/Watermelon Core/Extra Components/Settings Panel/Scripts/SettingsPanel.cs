...
namespace Watermelon
{
    public class SettingsPanel : MonoBehaviour
    {
        ...
        public void Show()
        {
            ...
            for (int i = 0; i < instance.SettingsButtonsInfo.Length; i++)
            {
                SettingsButtonInfo info = instance.SettingsButtonsInfo[i];

                info.SettingsButton.SetGamepadButtonFocus(true);
            }
        ...
        public void Hide(bool immediately = false)
        {
            ...
            for (int i = 0; i < instance.SettingsButtonsInfo.Length; i++)
            {
                ...
                info.SettingsButton.SetGamepadButtonFocus(false);
            }
