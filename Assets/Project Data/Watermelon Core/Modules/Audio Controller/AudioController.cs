...
{ 
    public class AudioController
    {
        ...
        private static AudioSave audioSave;
        ...
        public void Initialise(AudioSettings settings, GameObject targetGameObject)
        {
            ...
            audioSave = SaveController.GetSaveObject<AudioSave>("audio");
            ...
            // Load default states
            vibrationState = audioSave.IsVibrationActive;
            volume = audioSave.Volume;
        ...
        {
            return audioSave.IsVibrationActive;
        }

        public static bool IsAudioModuleEnabled()
        {
            return audioSave.Volume > 0;
        }
        ...
        public static void SetVibrationState(bool vibrationState)
        {
            ...
            audioSave.IsVibrationActive = vibrationState;
