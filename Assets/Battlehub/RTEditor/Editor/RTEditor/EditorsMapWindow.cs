...
namespace Battlehub.RTEditor
{
    ...
    {
        [MenuItem("Tools/Runtime Editor/Inspector Configuration ...")]
        ...
        public static void ShowWindow()
        {
            ...
            window.titleContent = new GUIContent("Runtime Editor Inspector Config");
            window.Show();
        ...
        private void Init()
        {
            ...
            {
                var editorsMapCreator = assemblyCSharp.GetType("Battlehub.RTEditor.EditorsMapCreator");
                if (editorsMapCreator != null)
                {
                    IOC.UnregisterFallback<IEditorsMapCreator>();
                    IOC.RegisterFallback(() => (IEditorsMapCreator)Activator.CreateInstance(editorsMapCreator));
                }
            }
            ...
            m_objectEditorDescriptors = new[] { typeof(GameObject), typeof(Asset) }
            ...
            m_scriptEditorDescriptors = otherAssemblies.SelectMany(a => a.GetTypes())
                .Where(t => (typeof(MonoBehaviour).IsAssignableFrom(t) || typeof(ScriptableObject).IsAssignableFrom(t)) && t != typeof(Asset) && t.IsPublic && !t.IsGenericType)
