...
namespace Battlehub.RTSL
{
    ...
    public class ConfigWindow : EditorWindow
    {
        ...
        {
            get;//get { return EditorPrefs.GetBool("RTSL_ConfigAllowAutoOpen", true); }
            set;//set { EditorPrefs.SetBool("RTSL_ConfigAllowAutoOpen", value); }
        }

        [MenuItem("Tools/Runtime SaveLoad (Legacy)/Config")]
