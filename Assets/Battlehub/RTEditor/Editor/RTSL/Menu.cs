...
namespace Battlehub.RTSL
{
    public static class Menu
    {
        ...
        [MenuItem("Tools/Runtime SaveLoad (Legacy)/Misc/Convert to asset")]
...
#pragma warning restore 0612
        ...
        [MenuItem("Tools/Runtime SaveLoad (Legacy)/Create RTSL", priority = 0)]
        ...
        //[MenuItem("Tools/Runtime SaveLoad (Legacy)/Persistent Classes/Create")]
        ...
        [MenuItem("Tools/Runtime SaveLoad (Legacy)/Persistent Classes/Edit")]
        public static void EditPersistentClasses()
        {
            PersistentClassMapperWindow.ShowWindow();
        }

        [MenuItem("Tools/Runtime SaveLoad (Legacy)/Persistent Classes/Clean")]
        ...
        //[MenuItem("Tools/Runtime SaveLoad (Legacy)/Libraries/Collect Scene Dependencies")]
        ...
        [MenuItem("Tools/Runtime SaveLoad (Legacy)/Update Libraries")]
        ...
        //[MenuItem("Tools/Runtime SaveLoad (Legacy)/Libraries/Update Built-In Assets Library")]
        ...
        //[MenuItem("Tools/Runtime SaveLoad (Legacy)/Libraries/Update Shader Profiles")]
        ...
        //[MenuItem("Tools/Runtime SaveLoad (Legacy)/Libraries/Update Asset Libraries List")]
        ...
        [MenuItem("Assets/Create/Runtime SaveLoad (Legacy)/Runtime Asset Library", priority = 0)]
        private static void CreateAssetLibrary()
        {
            CreateAssetLibrary(null);
        }

        [MenuItem("Tools/Runtime SaveLoad (Legacy)/Create Runtime Asset Library", priority = 0)]
        ...
        //[MenuItem("Tools/Runtime SaveLoad (Legacy)/Build All")]
