...
namespace Battlehub.UIControls.MenuControl
{
    ...
    public class Menu : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            if(MenuInput.LeftMouseButtonDown || MenuInput.MiddleMouseButtonDown || MenuInput.RightMouseButtonDown || MenuInput.ActiveTouchesCount > 0 && MenuInput.TouchPhaseEnded(0))
            {
                if(m_child == null)
                {
    ...
    internal static class MenuInput
    {
        ...
        {
            get { return Mouse.current.rightButton.wasReleasedThisFrame; }
        }
        ...
        public static int ActiveTouchesCount
        {
            get { return Touch.activeTouches.Count; }
        }

        public static bool TouchPhaseEnded(int index)
        {
            return Touch.activeTouches[index].phase == TouchPhase.Ended;
        }
        ...
        public static bool TouchPhaseEnded(int index)
        {
            return Input.GetTouch(index).phase == UnityEngine.TouchPhase.Ended;
        }       
#endif
    }
}
