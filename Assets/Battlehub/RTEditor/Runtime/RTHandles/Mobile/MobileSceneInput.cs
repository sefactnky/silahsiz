...
namespace Battlehub.RTHandles
{
    public class MobileSceneInput : RuntimeSelectionInputBase
    {
        ...
        private float m_prevOrthographicSize;
        ...
        protected override void Start()
        {
            ...
            {
                m_sceneControls = SceneComponent.Window.GetComponentInChildren<MobileSceneControls>(true);
                if (m_sceneControls == null)
                {
                ...
                {
                    m_sceneControls.gameObject.SetActive(true);
                }
            }
        ...
        protected virtual bool EndDrag()
        {
            ...
            {
                TouchPhase p0 = input.GetTouch(0).phase;
                TouchPhase p1 = input.GetTouch(1).phase;

                if (p0 != TouchPhase.Canceled && p0 != TouchPhase.Ended ||
                    p1 != TouchPhase.Canceled && p1 != TouchPhase.Ended)
                {
                    return false;
                }
            }
        ...
        protected override void LateUpdate()
        {
            ...
            if (!m_cameraTransformChanged)
            {
                ...
                if (!Mathf.Approximately(m_prevOrthographicSize, window.Camera.orthographicSize))
                {
                    m_cameraTransformChanged = true;
                }
                ...
                if (pan)
                {
                    if (!MathHelper.Approximately(m_prevCameraPosition, sceneComponent.CameraPosition, 0.01f))
                    {
                        m_cameraTransformChanged = true;
                    }
                }
        ...
        private void ResetCameraTransformChanged()
        {
            ...
            m_prevOrthographicSize = SceneComponent.Window.Camera.orthographicSize;
