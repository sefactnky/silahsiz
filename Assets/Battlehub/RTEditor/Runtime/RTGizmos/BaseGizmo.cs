...
namespace Battlehub.RTGizmos
{
    ...
    public abstract class BaseGizmo : RTEComponent
    {
        ...
        public virtual object TargetComponent
        {
            get;
        }
        ...
        {
            get { return Matrix4x4.TRS(TargetTransform.position, TargetTransform.rotation, TargetTransform.lossyScale).inverse; }
        }
        ...
        protected override void Start()
        {
            ...
            if (m_rteCamera == null && SceneCamera != null)
            {
                ...
                if(graphics != null)
                {
                    m_rteCamera = graphics.GetOrCreateCamera(SceneCamera, CameraEvent, false, false);
                }
        ...
        {
            BaseGizmo[] gizmos = UnityObjectExt.FindObjectsByType<BaseGizmo>();
