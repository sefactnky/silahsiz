    ...
    public class RectTransformGizmo : UIBehaviour, IRTEComponent
    {
        ...
        protected virtual void OnCommandBufferRefresh(IRTECamera camera)
        {
            if(m_canvasRT != null)
            {
                ...
                camera.RTECommandBuffer.DrawMesh(m_canvasMesh, Matrix4x4.identity, m_parentMaterial);
            }
            ...
            if (m_parentRT != null)
            {
                ...
                camera.RTECommandBuffer.DrawMesh(m_parentMesh, Matrix4x4.identity, m_parentMaterial);
            }
            ...
            if (m_rt != null)
            {
                ...
                camera.RTECommandBuffer.DrawMesh(m_mesh, Matrix4x4.identity, m_material);
            }
        }
