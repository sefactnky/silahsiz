...
namespace Battlehub.RTSL
{
    ...
    public abstract class PersistentSurrogate<TID> : PersistentSurrogateBase, IPersistentSurrogate<TID>
    {
        ...
        protected T GetPrivate<T>(object obj, string fieldName)
        {
            ...
            FieldInfo fieldInfo = type.GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly);
            if (fieldInfo == null)
            {
        ...
        protected T GetPrivate<V, T>(object obj, string fieldName)
        {
            ...
            if (fieldInfo == null)
            {
                fieldInfo = typeof(V).GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance);
                if (fieldInfo == null)
                {
                    return default;
                }
