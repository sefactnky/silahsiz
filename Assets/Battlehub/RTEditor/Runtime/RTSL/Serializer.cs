...
namespace Battlehub.RTSL
{
    ...
    public class ProtobufSerializer : ISerializer
    {
        ...
        static ProtobufSerializer()
        {
            ...
            if (model == null)
            {
                UnityEngine.Debug.LogError("RTSLTypeModel.dll was not found. Please build type model using the Build All button available through the Tools->Runtime SaveLoad (Legacy)->Config menu item in Unity Editor.");
            }
#endif
            if (model == null)
            {
            ...
            {
                Debug.LogWarning("RTSLTypeModel.dll was not found. Please build type model using the Build All button available through the Tools->Runtime SaveLoad (Legacy)->Config menu item");
            }
