...
namespace Battlehub.RTEditor
{
    ...
    public class InspectorView : RuntimeWindow
    {
        ...
        private async void SaveAndCreateEditor(UnityObject[] unselectedObjects)
        {
            if (m_editor != null && unselectedObjects != null && unselectedObjects.Length > 0)
            {
                ...
                if (editor.IsDirty)
                {
                    ...
                    await editor.SaveAssetsAsync(unselectedObjects);
                    CreateEditor();
                }
                else
                {
        ...
        protected override void OnDeactivated()
        {
            ...
            {
                editor.IsDirty = false;
                editor.SaveAssetsAsync(SelectedObjects);
            }
        }
