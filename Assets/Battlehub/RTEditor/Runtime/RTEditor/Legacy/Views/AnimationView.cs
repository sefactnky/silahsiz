...
#pragma warning restore CS0414
        ...
        {
            IOC.Resolve<IWindowManager>().CreateDialogWindow(BuiltInWindowNames.SaveAsset, m_localization.GetString("ID_RTEditor_AnimationView_SaveAnimationClip", "Save Animation Clip"),
                (sender, args) => { });
        ...
        private void SaveCurrentClip()
        {
            if (CurrentClip != null)
            {
                ...
                if (editor != null)
                {
                    editor.SaveAssetsAsync(new[] { CurrentClip });
                }
            }
        }
