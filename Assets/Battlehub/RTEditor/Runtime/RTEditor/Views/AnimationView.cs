...
namespace Battlehub.RTEditor.Views
{
    ...
    public class AnimationView : View
    {
        ...
        {
            string saveSceneDialogName = BuiltInWindowNames.SaveAsset;

            IOC.Resolve<IWindowManager>().CreateDialogWindow(saveSceneDialogName, m_localization.GetString("ID_RTEditor_AnimationView_SaveAnimationClip", "Save Animation Clip"),
                (sender, args) => { });
            ...
            clip.name = m_localization.GetString("ID_RTEditor_AnimationView_NewAnimationClip", "Animation Clip");
            ...
            saveAssetDialog.SelectSavedAssets = false;
