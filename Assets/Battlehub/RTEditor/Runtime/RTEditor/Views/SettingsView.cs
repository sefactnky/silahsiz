...
namespace Battlehub.RTEditor.Views
{
    public class SettingsView : View
    {
        ...
        protected override void Start()
        {
            ...
            {
                m_graphicsHeader.gameObject.SetActive(RenderPipelineInfo.Type != RPType.Standard && GraphicsSettingsExt.renderPipelineAsset != null && RenderPipelineInfo.IsBuiltInRendererPipelineAssetName(GraphicsSettingsExt.renderPipelineAsset.name));
            ...
            {
                m_graphicsQualityEditor.gameObject.SetActive(RenderPipelineInfo.Type != RPType.Standard && GraphicsSettingsExt.renderPipelineAsset != null && RenderPipelineInfo.IsBuiltInRendererPipelineAssetName(GraphicsSettingsExt.renderPipelineAsset.name));
        ...
        private IEnumerator CoEndEditUIScale()
        {
            ...
            m_parentDialog.ParentRegion.Fit(m_parentDialog.ParentRegion.CanResize);
        }
