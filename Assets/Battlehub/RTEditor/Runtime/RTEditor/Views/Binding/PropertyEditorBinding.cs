...
namespace Battlehub.RTEditor.Binding
{
    ...
    public class PropertyEditorBinding : AbstractMemberBinding
    {
        ...
        public override void Connect()
        {
            ...
            InitPropertyEditor(viewModel, propertyName, label);
        }

        protected virtual void InitPropertyEditor(object viewModel, string propertyName, string label)
        {
