...
namespace Battlehub.RTEditor
{
    ...
    public class RigidbodyComponentDescriptor : ComponentDescriptorBase<Rigidbody>
    {
        public override PropertyDescriptor[] GetProperties(ComponentEditor editor, object converter)
        {
            ...
            MemberInfo dragInfo = Strong.PropertyInfo((Rigidbody x) => x.linearDamping, "drag");
            MemberInfo angularDragInfo = Strong.PropertyInfo((Rigidbody x) => x.angularDamping, "angularDrag");
#else
