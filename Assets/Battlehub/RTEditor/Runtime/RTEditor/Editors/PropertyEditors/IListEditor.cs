...
namespace Battlehub.RTEditor
{
    public abstract class IListEditor : PropertyEditor<IList>, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        private void CreateElementEditors()
        {
            ...
            var valueInfo = Strong.MemberInfo((IListElementAccessor x) => x.Value);
            var childDescriptors = ChildDescriptors != null ? ChildDescriptors.Values.ToArray() : null;
            for (int i = 0; i < minCount; ++i)
            {
                ...
                editor.Init(accessors, valueInfo, childDescriptors, accessors[0].Name,  false, OnBeginRecordValue, OnEndRecordValue);
            }
        }
        ...
        protected override void ReloadOverride(bool force, bool raiseValueChanged)
        {
            ...
            bool valueChanged = CurrentValue == null || value == null || Size != value.Count;
