...
namespace Battlehub.RTEditor.Mobile.Models
{
    ...
    {
        event EventHandler<ValueChangedArgs<bool>> IsInspectorOpenedChanging;
        ...
        event EventHandler<ValueChangedArgs<bool>> IsMainMenuOpenedChanging;
    ...
    {
        public event EventHandler<ValueChangedArgs<bool>> IsInspectorOpenedChanging;
        ...
        public bool IsInspectorOpened
        {
            ...
            set
            {
                if (m_isInspectorOpened != value)
                {
                    ...
                    IsInspectorOpenedChanging?.Invoke(this, new ValueChangedArgs<bool>(!m_isInspectorOpened, m_isInspectorOpened));
        ...
        public event EventHandler<ValueChangedArgs<bool>> IsMainMenuOpenedChanging;
        ...
        public bool IsMainMenuOpened
        {
            ...
            set
            {
                if (m_isMenuOpened != value)
                {
                    ...
                    IsMainMenuOpenedChanging?.Invoke(this, new ValueChangedArgs<bool>(!m_isMenuOpened, m_isMenuOpened));
                    if (m_isMenuOpened)
                    {
