...
namespace Battlehub.RTEditor.Mobile.Views
{
    public class MobileHeaderView : MonoBehaviour
    {
        ...
        private IMobileEditorModel m_mobileEditor;
        ...
        private void Awake()
        {
            ...
            m_mobileEditor = IOC.Resolve<IMobileEditorModel>();
            m_mobileEditor.IsInspectorOpenedChanging += IsInspectorOpenedChanging;
        }
        ...
        private void IsInspectorOpenedChanging(object sender, ValueChangedArgs<bool> e)
        {
            if (m_creatorWindow != null)
            {
                HideCreator();
