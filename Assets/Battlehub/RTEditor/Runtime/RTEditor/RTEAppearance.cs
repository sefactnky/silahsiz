...
namespace Battlehub.RTEditor
{
    ...
    public struct RTEHierarchyColors
    {
        ...
        public Color InstanceItem;
        public Color DisabledInstanceItem;
                
        public RTEHierarchyColors(Color normal, Color disabled, Color instance, Color disabledInstance)
        {
            NormalItem = normal;
            DisabledItem = disabled;
            InstanceItem = instance;
            DisabledInstanceItem = disabledInstance;
        }
        ...
        public bool EqualTo(RTEHierarchyColors c)
        {
            return
                ...
                c.InstanceItem == InstanceItem &&
                c.DisabledInstanceItem == DisabledInstanceItem;
        }
    }
    ...
    public class RTEColors
    {
        ...
        public static readonly RTEHierarchyColors DefaultHierarchy = new RTEHierarchyColors(Color.white, new Color32(0x93, 0x92, 0x92, 0xFF), new Color32(0x7F, 0xD5, 0xFC, 0xFF), new Color32(0x7F, 0xD5, 0xFC, 0x7F));
    ...
    public class RTEAppearance : MonoBehaviour, IRTEAppearance
    {
        ...
        private void UpdateLayerOffsets()
        {
            ...
            if (m_modalLayer != null)
            {
                if (IsUIBackgroundActive)
                {
                    //m_modalLayer.SetPivot(Vector2.zero); -> breaks modal layer transform unity 6
