...
namespace Battlehub.RTEditor
{
    ...
    public class TimelineGrid : MonoBehaviour
    {
        ...
        private void OnCommandBufferRefresh(IRTECamera camera)
        {
            ...
            if (m_vGridMesh0 != null)
            {
                m_rteCamera.RTECommandBuffer.DrawMesh(m_vGridMesh0, vMatrix, m_vGridMaterial0);
            }

            Matrix4x4 hMatrix = Matrix4x4.TRS(offset, Quaternion.identity, scale);
            if (m_hGridMesh0 != null)
            {
                m_rteCamera.RTECommandBuffer.DrawMesh(m_hGridMesh0, hMatrix, m_hGridMaterial0);
            }
            ...
            if (m_vGridMesh1 != null)
            {
                m_rteCamera.RTECommandBuffer.DrawMesh(m_vGridMesh1, vMatrix, m_vGridMaterial1);
            }
            ...
            if (!fixedHeight)
            {
                ...
                if (m_hGridMesh1 != null)
                {
                    m_rteCamera.RTECommandBuffer.DrawMesh(m_hGridMesh1, hMatrix, m_hGridMaterial1);
                }
            }
            ...
            if (m_vGridMesh2 != null)
            {
                ...
                {
                    m_rteCamera.RTECommandBuffer.DrawMesh(m_vGridMesh2, vMatrix, m_vGridMaterial2);
                }
            }
            ...
            if (!fixedHeight)
            {
                ...
                if (m_hGridMesh2 != null)
                {
                    ...
                    {
                        m_rteCamera.RTECommandBuffer.DrawMesh(m_hGridMesh2, hMatrix, m_hGridMaterial2);
                    }
                }
            }
        }
