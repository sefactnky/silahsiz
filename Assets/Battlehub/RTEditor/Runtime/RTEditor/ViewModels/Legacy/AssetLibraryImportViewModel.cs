...
{
    public interface IAssetLibraryImportDialog
    {
    ...
    [Binding]
    public class AssetLibraryImportViewModel : HierarchicalDataViewModel<ProjectItem>, IAssetLibraryImportDialog
    {
        public event EventHandler<IAssetLibraryImportDialog.CloseEventArgs> Closed;
        ...
        {
            base.Awake();
            IOC.RegisterFallback<IAssetLibraryImportDialog>(this);
        }
        ...
        protected override void OnDestroy()
        {
            ...
            IOC.UnregisterFallback<IAssetLibraryImportDialog>(this);
        }
        ...
        {
            Closed?.Invoke(this, new IAssetLibraryImportDialog.CloseEventArgs(e.Result));
        }
