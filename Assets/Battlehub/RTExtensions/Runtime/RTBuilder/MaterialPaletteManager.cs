...
namespace Battlehub.RTBuilder
{
    ...
    public class MaterialPaletteManager : MonoBehaviour, IMaterialPaletteManager
    {
        ...
        {
            m_palette = UnityObjectExt.FindAnyObjectByType<MaterialPalette>();
            if (m_palette == null)
            {
                ...
                Transform root = null;
                if (m_editor.HierarchyRoot != null)
                {
                    root = m_editor.HierarchyRoot.transform;
                }
                m_palette.transform.SetParent(root, false);
