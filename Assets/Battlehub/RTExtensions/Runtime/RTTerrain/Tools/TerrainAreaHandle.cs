...
namespace Battlehub.RTTerrain
{
    public class TerrainAreaHandle : BaseHandle
    {
        ...
        protected override void RefreshCommandBuffer(IRTECamera camera)
        {
            ...
            camera.RTECommandBuffer.DrawMesh(m_areaResizerMesh, Matrix4x4.identity, m_areaResizerMaterial, 0);
            ...
            Appearance.DoPositionHandle(camera.RTECommandBuffer, camera.Camera, m_drawingSettings);
