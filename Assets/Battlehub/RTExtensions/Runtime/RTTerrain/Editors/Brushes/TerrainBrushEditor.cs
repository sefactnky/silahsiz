...
namespace Battlehub.RTTerrain
{
    public class TerrainBrushEditor : MonoBehaviour
    {
        ...
        [SerializeField]
        private string m_selectTextureDialogName;
        ...
        private void Awake()
        {
            ...
            m_source = UnityObjectExt.FindAnyObjectByType<TerrainBrushSource>();
            if(m_source == null)
            {
                m_source = new GameObject("TerrainBrushSource").AddComponent<TerrainBrushSource>();

                var root = m_editor.HierarchyRoot?.transform;
                m_source.transform.SetParent(root, false);
            }
        ...
        private void OnAddButtonClick()
        {
            ...
            Transform dialogTransform = IOC.Resolve<IWindowManager>().CreateDialogWindow(string.IsNullOrEmpty(m_selectTextureDialogName) ? BuiltInWindowNames.SelectObject : m_selectTextureDialogName, "Select Texture",
                 (sender, args) =>
                 {
