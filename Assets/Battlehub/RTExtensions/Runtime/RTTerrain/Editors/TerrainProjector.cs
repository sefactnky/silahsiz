    ...
    public abstract class  TerrainProjectorBase : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            if (m_terrain != null && !m_editor.Tools.IsViewing && m_terrainBrush != null)
            {
                ...
                {
                    m_terrainBrush.Terrain = m_terrain;
                    m_terrainBrush.Paint(m_terrain.transform.InverseTransformPoint(m_position), (m_editor.Input.GetKey(KeyCode.LeftShift) ? -Time.unscaledDeltaTime : Time.unscaledDeltaTime) * 100.0f, Opacity / 100.0f);
                }
            }
        }
    }
